...
public interface IMultiLlistaGenerica<A, B> {
	 ...
	 */
	void inserir(A a, B b) throws ElementRepetit, ElementNoTrobat;
	 ...
	 */
	void esborrar(A a, B b) throws ElementNoTrobat;
	 ...
	 */
	List<B> fila(A a) throws ElementNoTrobat;
	 ...
	 */
	List<A> columna(B b) throws ElementNoTrobat;
	 ...
	 */
	boolean existeix(A a, B b) throws ElementNoTrobat;
}